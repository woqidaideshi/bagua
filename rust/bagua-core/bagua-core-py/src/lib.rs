...
impl BaguaBucketPy {
    ...
    pub fn append_centralized_sparse_py_rust_synchronous_op(
        ...
        self.inner.append_centralized_sparse_py_rust_synchronous_op(
            communicator_internode.map(|x| &x.inner),
            communicator_intranode.map(|x| &x.inner),
            hierarchical,
            compression,
    ...
    pub fn append_centralized_sparse_py_cuda_synchronous_op(
        ...
        self.inner.append_centralized_sparse_py_cuda_synchronous_op(
            communicator_internode.map(|x| &x.inner),
            communicator_intranode.map(|x| &x.inner),
            hierarchical,
            compression,
    ...
    pub fn append_centralized_sparse_py_synchronous_op(
        ...
        self.inner.append_centralized_sparse_py_synchronous_op(
            communicator_internode.map(|x| &x.inner),
            communicator_intranode.map(|x| &x.inner),
            hierarchical,
            compression,
    ...
    pub fn append_centralized_sparse_synchronous_op(
        ...
        hierarchical: bool,
        compression: Option<String>,
        value_tensor: PyRef<BaguaTensorPy>,
        other_tensor: PyRef<BaguaTensorPy>,
    ) -> PyResult<()> {
