...
#[derive(Debug)]
pub struct CentralizedFullPrecisionSparseInplaceParallelSynchronous {
    pub communicator: BaguaCommunicator,
    pub other_tensor: BaguaTensor,
}

impl CommOpTrait for CentralizedFullPrecisionSparseInplaceParallelSynchronous {
    fn execute_background_communication(
        ...
        self.communicator.execute_communication(
            ...
            &mut |c, t| {
                ...
                unsafe {
                    // method 1:
                    let mut index_ptr = recv_index_tensor.data_ptr();
                    let mut value_ptr = recv_value_tensor.data_ptr();
                    let mut total_count = other_tensor_raw.num_elements();
                    for i in 0..c.nranks {
                        if i > 0 {
                            total_count = 0;
                        }
                        ...
                        value_ptr += send_value_tensor.num_elements() as u64 * send_value_tensor.dtype().bytes() as u64;
                    }
                    /////////////////////////
                    // method 2:
                    // kernels::sparse_gather_parallel_host(
