...
#[derive(Debug)]
pub struct CentralizedFullPrecisionSparsePyRustSynchronous {
...
impl CommOpTrait for CentralizedFullPrecisionSparsePyRustSynchronous {
    fn execute_background_communication(
        ...
        self.communicator.execute_communication(
            ...
            &mut |c, t| {
                ...
                other_value_raw.sparse_from_index(&mut t.raw, send_value_raw);
                // unsafe {
                //     kernels::sparse_extract_cpp(
                ...
                other_value_raw.sparse_gather_from_index(recv_index_raw, recv_value_raw);
                // unsafe {
                //     kernels::sparse_gather_cpp(
