...
from bagua.torch_api.algorithms.q_adam import QAdamOptimizer, QAdamAlgorithmImpl, QAdamAlgorithm
...
class QadamDecentralizedAlgorithmImpl(QAdamAlgorithmImpl):
    def __init__(
        self,
        process_group: BaguaProcessGroup,
        ...
        Args:
            ...
            communication_interval (int): Number of iterations between two communication steps.
        """
        super(QadamDecentralizedAlgorithmImpl, self).__init__(process_group)
        self.hierarchical = hierarchical
        self.communication_interval = communication_interval
...
class QadamDecentralizedAlgorithm(QAdamAlgorithm):
    def __init__(self, q_adam_optimizer: QAdamOptimizer, hierarchical: bool = True, communication_interval: int = 1):
        """
        Create an instance of the
        `Low Precision Decentralized SGD <https://tutorials.baguasys.com/algorithms/low-precision-decentralized>`_
        algorithm.
    ...
    def reify(
        self, process_group: BaguaProcessGroup
    ) -> QadamDecentralizedAlgorithmImpl:
        return QadamDecentralizedAlgorithmImpl(
            process_group,
            hierarchical=self.hierarchical,
            communication_interval=self.communication_interval,
